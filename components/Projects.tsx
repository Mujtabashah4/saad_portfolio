...
const projects = [
  {
    ...
    description:
      "Lahore's mass rapid transit system — a landmark urban infrastructure project. Key role in ground improvement, soil investigation, and critical civil engineering at scale across the city.",
